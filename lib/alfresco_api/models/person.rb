...
module AlfrescoAPI
  ...
  class Person
    ...
    def hash
      [id, first_name, last_name, description, avatar_id, email, skype_id, google_id, instant_message_id, job_title, location, company, mobile, telephone, status_updated_at, user_status, enabled, email_notifications_enabled, aspect_names, properties].hash
    end
