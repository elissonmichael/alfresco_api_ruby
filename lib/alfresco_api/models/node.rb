...
module AlfrescoAPI
  ...
  class Node
    ...
    def hash
      [id, name, node_type, is_folder, is_file, is_locked, modified_at, modified_by_user, created_at, created_by_user, parent_id, is_link, content, aspect_names, properties, allowable_operations, path, permissions].hash
    end
