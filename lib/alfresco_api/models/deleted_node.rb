...
module AlfrescoAPI
  ...
  class DeletedNode
    ...
    def list_invalid_properties
      ...
      if @archived_by_user.nil?
        invalid_properties.push("invalid value for 'archived_by_user', archived_by_user cannot be nil.")
      end
    ...
    def hash
      [id, name, node_type, is_folder, is_file, is_locked, modified_at, modified_by_user, created_at, created_by_user, parent_id, is_link, content, aspect_names, properties, allowable_operations, path, permissions, archived_by_user, archived_at].hash
    end
