...
module AlfrescoAPI
  ...
  class SharedLink
    ...
    def hash
      [id, expires_at, node_id, name, title, description, modified_at, modified_by_user, shared_by_user, content, allowable_operations, allowable_operations_on_target].hash
    end
