...
# Unit tests for AlfrescoAPI::SiteMember
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SiteMember' do
  before do
    # run before each test
    @instance = AlfrescoAPI::SiteMember.new
  end
  ...
  describe 'test an instance of SiteMember' do
    it 'should create an instance of SiteMember' do
      expect(@instance).to be_instance_of(AlfrescoAPI::SiteMember)
    end
  end
